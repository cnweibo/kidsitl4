			...
			<div class="tab-pane active" id="tab-general">
				...
				<div class="form-group {{{ $errors->has('content') ? 'has-error' : '' }}}">
					<div class="col-md-12">
						...
						<textarea class="form-control full-width wysihtml5" name="relatedwords" value="relatedwords" rows="10">{{{$bishun->relatedwords}}}</textarea>
				...
				<div class="form-group {{{ $errors->has('content') ? 'has-error' : '' }}}">
					<div class="col-md-12">
						...
						<textarea class="form-control full-width wysihtml5" name="filename" value="filename" rows="10">{{{$bishun->filename}}}</textarea>
						{{{ $errors->first('content', '<span class="help-block">:message</span>') }}}
					</div>
				</div>
				@endforeach
