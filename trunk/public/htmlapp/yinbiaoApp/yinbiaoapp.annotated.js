...
kidsitApplication.directive('mp3Player',['$rootScope', function($rootScope){
...
kidsitApplication.controller('mp3PlayerCtrl', ['$scope', 'mp3PlayerService', function($scope,mp3PlayerService) {
...
kidsitApplication.controller('WordsPlayListCtrl', ['$scope', 'mp3PlayerService', function($scope,mp3PlayerService) {
  var thisctrl = this;
  $scope.mp3PlayList = [];
...
kidsitApplication.directive('wordsPlayList',['mp3PlayerService', '$rootScope', function(mp3PlayerService,$rootScope) {
  return {
    restrict: 'A',
    scope: {id:'='},
...
kidsitApplication.controller('playListsCtrl',['$rootScope', function($rootScope){
